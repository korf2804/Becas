		...
		<div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1">
			<div class="table-responsive">
				...
				<table class="table table-hover table-condensed " style="font-size:12px;">
					...
					?>	
					<tr>
						<td><?php echo $tipo->SB_MatriculaBecado; ?></td>
						<td><?php echo $tipo->SB_RutBecado; ?></td>
						<td><?php echo $tipo->SB_NomBecado. " ".$tipo->SB_ApePatBecado. " ".$tipo->SB_ApeMatBecado; ?></td>
						<td><?php echo $tipo->SB_CursoBecado; ?></td>
						<td><?php echo $tipo->SB_BecasFotocopia; ?></td>
						<td><?php echo $tipo->SB_BecasImpresion; ?></td>
						<td><?php echo $tipo->SB_SemestreBecado; ?></td>
					</tr>
					<?php
						endforeach;
					?>
