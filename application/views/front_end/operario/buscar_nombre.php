<div class="container">
    <div class="row">
        <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
        	<h1>Busqueda de alumnos por Nombre</h1>
        	<h3>Ingrese nombre a buscar y seleccione carrera</h3>
        	<br />
        	<form class="form-horizontal" action="<?php echo base_url(); ?>index.php/operario/buscar/resultado_busqueda_nombre" method="post">
    				<div class="form-group">
      				<label for="inputName" class="control-label col-lg-2 col-xs-12">Nombre:</label>
              <div class="col-xs-9">
                <input type="text" class="form-control input-lg col-xs-12" placeholder="Ejemplo: Juan Alfredo" name="nombre">
              </div>
